...
(def chapter-1
  ...
  (q/fill 244 213 221) ;; #f4d5dd
  (q/triangle 20 20, 60 90, 15 60)

  (q/fill 249 202 216) ;; #f9cad8
  (q/triangle 220 210, 280 260, 215 240)

  (q/fill 232 181 188) ;; #e8b5bc
  (q/triangle 150 40, 227 50, 90 170))
